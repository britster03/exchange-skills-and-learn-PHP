...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($request) {
        if ($status == 'accept') {
            ...
            $message = 'Your skills exchange request has been accepted. Let us have a chat soon.';
        } elseif ($status == 'reject') {
            $subject = 'Exchange Request Rejected';
            $message = 'Your skills exchange request has been accepted. Try connecting with some other skills user.';
        }
